var url = new Object({
    ...
    changePayCode: 'http://192.168.123.215:5000/v1/pay/set',
    getMyPayCode: 'http://192.168.123.215:5000/v1/pay/getmy',
    ...
    cancelPolice: 'http://192.168.123.215:5000/v1/police/cancel', //撤销举报接口
    changeSchool: 'http://192.168.123.215:5000/v1/school/change', //选择学校
    searchSchool: 'http://192.168.123.215:5000/v1/school/search', //搜索学校

    getAllSchool: 'http://192.168.123.215:5000/v1/school/getAll' //暂时使用，获得所有学校列表接口
})

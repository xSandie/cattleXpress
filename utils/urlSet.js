var testurl = new Object({
    ...
    baseInfoUrl: 'http://127.0.0.1:5000/minav1/auth/base_info',
    configUrl: 'http://127.0.0.1:5000/minav1/school/config',
    ...
    checkUnPay:'http://127.0.0.1:5000/minav1/orders/unpay',//todo 检查是否有未支付的

    postAvatar: 'http://127.0.0.1:5000/minav1/auth/wxSetAvatar', //上传用户昵称头像接口
    ...
    policePub: 'http://127.0.0.1:5000/minav1/police/report_pub', //首次发起举报
    policePic: 'http://127.0.0.1:5000/minav1/police/pic', //上传举报图片
    complainPub: 'http://127.0.0.1:5000/minav1/police/complain', //首次发起举报

    usrinfo: 'http://127.0.0.1:5000/minav1/auth/wx_usrinfo', //我的页面获取用户基本信息
    policelist: 'http://127.0.0.1:5000/minav1/police/list', //查询举报条目列表
    reportDetail: 'http://127.0.0.1:5000/minav1/police/report_detail', //获取举报详情
    ...
    reportExError:'http://127.0.0.1:5000/minav1/fdbck/exp_station_error',
    ...
    intelliRecogn:'http://127.0.0.1:5000/minav1/exp/recogn',
    collectFormId:'http://127.0.0.1:5000/minav1/pstMsg/formId'//收集formId
})
var url = new Object({
    ...
    adsDetail:'https://ads.inschool.tech/ad/detail',//广告详情
    relativeRoute:'https://ads.inschool.tech',//广告图片相对路径
    // checkUnpay:'http://127.0.0.1:5000'//检查是否有未支付的
})
exports.url = testurl;